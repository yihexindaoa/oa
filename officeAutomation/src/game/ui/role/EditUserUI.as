	...
	public class EditUserUI extends Dialog {
		...
		protected static var uiXML:XML =
			<Dialog width="271" height="190">
			  <Image skin="png.comp.bg" y="0" height="500" sizeGrid="50,50,10,10" x="0" width="300" var="saveBtn"/>
			  ...
			  <ComboBox labels="label1,label2" skin="png.comp.combobox" x="92" y="173" height="23" var="positionInformation"/>
