	...
	public class EditUserUI extends Dialog {
		...
		protected static var uiXML:XML =
			<Dialog width="271" height="190">
			  ...
			  <ComboBox labels="admin,info,developmentAngineer,productManager,personnel,administrative" skin="png.comp.combobox" x="92" y="173" height="23" var="positionInformation"/>
			  ...
			  <ComboBox labels="赵要峰,陈敬通,陈树宏,宋琪" skin="png.comp.combobox" x="92" y="211" height="23" var="officeId"/>
			  <Label text="工号：" x="41" y="249" width="49" height="18"/>
			  <TextInput skin="png.comp.textinput" x="92" y="249" var="workNumber"/>
			  <Label text="id" x="241" y="313" var="id" visible="false"/>
			</Dialog>;
