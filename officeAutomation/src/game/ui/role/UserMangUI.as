			...
			<View width="800" height="900" buttonMode="true">
			  ...
			  <List x="170" y="165" spaceY="10" width="517" height="142" repeatX="1" repeatY="4" var="table">
			    <Box name="render" width="726" height="27" x="-120" y="0" left="-120">
			      ...
			      <Label text=" " x="250" y="0" height="34" align="center" size="15" width="103" background="true" backgroundColor="0x6699cc" name="positionInformation"/>
			      ...
			      <ComboBox x="361" y="3" width="71" height="23" name="officeId" labels="赵要峰,陈敬通,陈树宏,宋琪"/>
			    </Box>
			  </List>
