			...
			<View width="800" height="900" buttonMode="true">
			  ...
			  <List x="170" y="165" spaceY="10" width="517" height="142" repeatX="1" repeatY="4" var="table">
			    <Box name="render" width="726" height="27" x="-120" y="0" left="-120">
			      <Label x="621" y="0" width="106" height="34" background="true" backgroundColor="0x6699cc" text=" "/>
			      <Button label="编辑" skin="png.comp.button" x="637" y="3" width="30" height="23" labelColors="0x0000ff" name="editBtn"/>
			      <Button label="删除" skin="png.comp.button" x="684" y="3" width="34" height="23" labelColors="0x0000ff" name="deleteBtn"/>
			      <Label text="01" x="-1" y="0" width="49" height="34" align="center" size="15" background="true" backgroundColor="0x6699cc" name="roleId"/>
			      ...
			      <Label text=" " x="532" y="0" height="34" align="center" size="15" width="86" background="true" backgroundColor="0x6699cc" name="roleNme"/>
			      ...
			      <Button label="禁用" skin="png.comp.button" x="538" y="3" width="37" height="23" labelColors="0xff0000" name="disBtn"/>
			      <Button label="启用" skin="png.comp.button" x="580" y="3" width="35" height="23" labelColors="0x0000ff" name="adbleBtn"/>
			    </Box>
			  </List>
			  ...
			  <Label text="状态" x="581" y="134" width="86" height="30" background="true" backgroundColor="0x99cc" bold="true" align="center" size="18"/>
			  ...
			  <Label text="操作" x="671" y="134" height="30" width="106" background="true" backgroundColor="0x99cc" bold="true" align="center" size="18"/>
			</View>;
