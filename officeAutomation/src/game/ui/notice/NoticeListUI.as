	...
	public class NoticeListUI extends View {
		...
		protected static var uiXML:XML =
			<View width="1000" height="900">
			  ...
			  <List x="201" y="165" spaceY="10" width="517" height="142" repeatX="1" repeatY="4" var="table">
			    <Box name="render" width="726" height="27" x="-120" y="0" left="-120">
			      <Label x="621" y="0" width="257" height="34" background="true" backgroundColor="0x6699cc" text=" "/>
			      <Button label="审核通过" skin="png.comp.button" x="630" y="3" width="61" height="23" labelColors="0x0000ff" name="auditBtn"/>
			      <Button label="审核不通过" skin="png.comp.button" x="693" y="3" width="70" height="23" labelColors="0x0000ff" name="noBtn"/>
			      ...
			      <Button label="详情" skin="png.comp.button" x="765" y="3" width="35" height="23" name="detailsBtn"/>
			      ...
			      <Button label="删除" skin="png.comp.button" x="840" y="3" width="35" height="23" name="delete"/>
			      <Button label="编辑" skin="png.comp.button" x="802" y="3" width="36" height="23" name="edit"/>
			    </Box>
			  </List>
			  <Clip skin="png.comp.clip_timg" x="663" y="54" clipX="4" clipY="4" index="2" width="22" height="19" var="queryBtn"/>
			  <Label text="序号" x="79" y="134" width="50" height="30" background="true" backgroundColor="0x99cc" bold="true" size="18" selectable="true" align="center"/>
			  <Label text="通知类型" x="130" y="134" width="95" height="30" backgroundColor="0x99cc" background="true" size="18" bold="true" align="center"/>
			  <Label text="审批人" x="612" y="134" width="86" height="30" background="true" backgroundColor="0x99cc" bold="true" align="center" size="18"/>
			  <Label text="时间" x="331" y="134" width="104" height="30" background="true" backgroundColor="0x99cc" bold="true" align="center" size="18"/>
			  <Label text="状态" x="521" y="134" width="89" height="30" background="true" backgroundColor="0x99cc" bold="true" align="center" size="18"/>
			  <Label text="发布人" x="436" y="134" width="83" height="30" background="true" backgroundColor="0x99cc" bold="true" align="center" size="18"/>
			  <Label text="标题" x="226" y="134" width="104" height="30" background="true" backgroundColor="0x99cc" bold="true" align="center" size="18"/>
			  <Label text="操作" x="702" y="134" height="30" width="257" background="true" backgroundColor="0x99cc" bold="true" align="center" size="18"/>
			  ...
			  <Label text=" " x="43" y="134" width="35" height="30" backgroundColor="0x99cc" background="true" align="center"/>
			  <CheckBox skin="png.comp.checkbox" x="54" y="141" name="check"/>
			</View>;
