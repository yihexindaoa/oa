...
function as_initFullEdit(){
	...
	var 	layaIndex;layui.use('layedit', function(){	var layedit = layui.layedit;	layaIndex = layedit.build('demo');
...
function as_posFullEdit(lx,ly){console.log("富文本框",lx,ly);
