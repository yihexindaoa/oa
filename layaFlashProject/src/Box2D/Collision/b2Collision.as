...
package Box2D.Collision
{
	...
	public class b2Collision
	{
		...
		static public function EdgeSeparation(poly1:b2PolygonShape, xf1:b2Transform, edge1:int, poly2:b2PolygonShape, xf2:b2Transform):Number
		{
		...
		// from poly1.
		static public function FindMaxSeparation(edgeIndex:Vector.<int>, poly1:b2PolygonShape, xf1:b2Transform, poly2:b2PolygonShape, xf2:b2Transform):Number
		{
			var count1:int = poly1.m_vertexCount;
			var normals1:Vector.<b2Vec2> = poly1.m_normals;
		...
		static public function FindIncidentEdge(c:Vector.<ClipVertex>, poly1:b2PolygonShape, xf1:b2Transform, edge1:int, poly2:b2PolygonShape, xf2:b2Transform):void
		{
			var count1:int = poly1.m_vertexCount;
			var normals1:Vector.<b2Vec2> = poly1.m_normals;
